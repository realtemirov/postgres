...
* Satrlarni o'sish tartibida `ASC` va satrlarni kamayish tartibida `DESC` saralash opsiyasidan foydalaning. Ushbu band sukut bo'yicha variantdan `ORDER BY ASC` foydalanadi .
